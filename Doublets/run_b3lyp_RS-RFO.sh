...
#SBATCH -J B3LYP-DZ-doublets-RS-RFO
...
rm -f report_doublets_B3LYP_DZ_RS-RFO
#rm -f slurm*
...
echo 'Convergence statistics' > report_doublets_B3LYP_DZ_RS-RFO
echo '' >> report_doublets_B3LYP_DZ_RS-RFO
echo 'Basis set: ' $BASIS >> report_doublets_B3LYP_DZ_RS-RFO
echo 'SCF input: ' $SCFTYPE >> report_doublets_B3LYP_DZ_RS-RFO
echo 'SCF input: ' $Opt >> report_doublets_B3LYP_DZ_RS-RFO
...
for mol in Coordinates/{00..234}*.xyz ; do
  ...
  echo '' >> ../report_doublets_B3LYP_DZ_RS-RFO
  echo $Project ":" >> ../report_doublets_B3LYP_DZ_RS-RFO
  echo $line1 >> ../report_doublets_B3LYP_DZ_RS-RFO
  echo $line2 >> ../report_doublets_B3LYP_DZ_RS-RFO
  echo $line3 >> ../report_doublets_B3LYP_DZ_RS-RFO
  echo $line4 >> ../report_doublets_B3LYP_DZ_RS-RFO
  echo $line5 >> ../report_doublets_B3LYP_DZ_RS-RFO
  rm -r *
  cd -
done
