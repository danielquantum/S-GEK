...
#SBATCH -J HF-DZ-singlets_opt-RS-RFO
...
rm -f report_singlets_opt_HF_DZ_RS-RFO
#rm -f slurm*
...
echo 'Convergence statistics' > report_singlets_opt_HF_DZ_RS-RFO
echo '' >> report_singlets_opt_HF_DZ_RS-RFO
echo 'Basis set: ' $BASIS >> report_singlets_opt_HF_DZ_RS-RFO
echo 'SCF input: ' $SCFTYPE >> report_singlets_opt_HF_DZ_RS-RFO
echo 'SCF input: ' $Opt >> report_singlets_opt_HF_DZ_RS-RFO
...
for mol in Coordinates/{00..264}*.xyz ; do
  ...
  echo '' >> ../report_singlets_opt_HF_DZ_RS-RFO
  echo $Project ":" >> ../report_singlets_opt_HF_DZ_RS-RFO
  echo $line1 >> ../report_singlets_opt_HF_DZ_RS-RFO
  echo $line2 >> ../report_singlets_opt_HF_DZ_RS-RFO
  echo $line3 >> ../report_singlets_opt_HF_DZ_RS-RFO
  echo $line4 >> ../report_singlets_opt_HF_DZ_RS-RFO
  echo $line5 >> ../report_singlets_opt_HF_DZ_RS-RFO
  rm -r *
  cd -
done
