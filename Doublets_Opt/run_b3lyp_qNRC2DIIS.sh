...
#SBATCH -J B3LYP-DZ-doublets_opt-qNRC2DIIS
...
rm -f report_doublets_opt_B3LYP_DZ_qNRC2DIIS
#rm -f slurm*
...
echo 'Convergence statistics' > report_doublets_opt_B3LYP_DZ_qNRC2DIIS
echo '' >> report_doublets_opt_B3LYP_DZ_qNRC2DIIS
echo 'Basis set: ' $BASIS >> report_doublets_opt_B3LYP_DZ_qNRC2DIIS
echo 'SCF input: ' $SCFTYPE >> report_doublets_opt_B3LYP_DZ_qNRC2DIIS
echo 'SCF input: ' $Opt >> report_doublets_opt_B3LYP_DZ_qNRC2DIIS
...
for mol in Coordinates/{00..234}*.xyz ; do
  ...
  echo '' >> ../report_doublets_opt_B3LYP_DZ_qNRC2DIIS
  echo $Project ":" >> ../report_doublets_opt_B3LYP_DZ_qNRC2DIIS
  echo $line1 >> ../report_doublets_opt_B3LYP_DZ_qNRC2DIIS
  echo $line2 >> ../report_doublets_opt_B3LYP_DZ_qNRC2DIIS
  echo $line3 >> ../report_doublets_opt_B3LYP_DZ_qNRC2DIIS
  echo $line4 >> ../report_doublets_opt_B3LYP_DZ_qNRC2DIIS
  echo $line5 >> ../report_doublets_opt_B3LYP_DZ_qNRC2DIIS
  rm -r *
  cd -
done
