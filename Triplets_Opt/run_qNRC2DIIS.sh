...
#SBATCH -J HF-DZ-triplets_opt-qNRC2DIIS
...
rm -f report_triplets_opt_HF_DZ_qNRC2DIIS
#rm -f slurm*
...
echo 'Convergence statistics' > report_triplets_opt_HF_DZ_qNRC2DIIS
echo '' >> report_triplets_opt_HF_DZ_qNRC2DIIS
echo 'Basis set: ' $BASIS >> report_triplets_opt_HF_DZ_qNRC2DIIS
echo 'SCF input: ' $SCFTYPE >> report_triplets_opt_HF_DZ_qNRC2DIIS
echo 'SCF input: ' $Opt >> report_triplets_opt_HF_DZ_qNRC2DIIS
...
for mol in Coordinates/{00..264}*.xyz ; do
  ...
  echo '' >> ../report_triplets_opt_HF_DZ_qNRC2DIIS
  echo $Project ":" >> ../report_triplets_opt_HF_DZ_qNRC2DIIS
  echo $line1 >> ../report_triplets_opt_HF_DZ_qNRC2DIIS
  echo $line2 >> ../report_triplets_opt_HF_DZ_qNRC2DIIS
  echo $line3 >> ../report_triplets_opt_HF_DZ_qNRC2DIIS
  echo $line4 >> ../report_triplets_opt_HF_DZ_qNRC2DIIS
  echo $line5 >> ../report_triplets_opt_HF_DZ_qNRC2DIIS
  rm -r *
  cd -
done
