...
#triplets
#files = ['report_triplets_HF_DZ_qNRC2DIIS', 'report_triplets_HF_DZ_RS-RFO', 'report_triplets_HF_DZ_S-GEK', 'report_triplets_B3LYP_DZ_qNRC2DIIS', 'report_triplets_B3LYP_DZ_RS-RFO', 'report_triplets_B3LYP_DZ_S-GEK']
#triplets_opt
files = ['report_triplets_opt_HF_DZ_qNRC2DIIS', 'report_triplets_opt_HF_DZ_RS-RFO', 'report_triplets_opt_HF_DZ_S-GEK', 'report_triplets_opt_B3LYP_DZ_qNRC2DIIS', 'report_triplets_opt_B3LYP_DZ_RS-RFO', 'report_triplets_opt_B3LYP_DZ_S-GEK'] 
