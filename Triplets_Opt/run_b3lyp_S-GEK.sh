...
#SBATCH -J B3LYP-DZ-triplets_opt-S-GEK
...
rm -f report_triplets_opt_B3LYP_DZ_S-GEK
#rm -f slurm*
...
echo 'Convergence statistics' > report_triplets_opt_B3LYP_DZ_S-GEK
echo '' >> report_triplets_opt_B3LYP_DZ_S-GEK
echo 'Basis set: ' $BASIS >> report_triplets_opt_B3LYP_DZ_S-GEK
echo 'SCF input: ' $SCFTYPE >> report_triplets_opt_B3LYP_DZ_S-GEK
echo 'SCF input: ' $Opt >> report_triplets_opt_B3LYP_DZ_S-GEK
...
for mol in Coordinates/{00..264}*.xyz ; do
  ...
  echo '' >> ../report_triplets_opt_B3LYP_DZ_S-GEK
  echo $Project ":" >> ../report_triplets_opt_B3LYP_DZ_S-GEK
  echo $line1 >> ../report_triplets_opt_B3LYP_DZ_S-GEK
  echo $line2 >> ../report_triplets_opt_B3LYP_DZ_S-GEK
  echo $line3 >> ../report_triplets_opt_B3LYP_DZ_S-GEK
  echo $line4 >> ../report_triplets_opt_B3LYP_DZ_S-GEK
  echo $line5 >> ../report_triplets_opt_B3LYP_DZ_S-GEK
  rm -r *
  cd -
done
