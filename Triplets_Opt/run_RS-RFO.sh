...
#SBATCH -J HF-DZ-triplets_opt-RS-RFO
...
rm -f report_triplets_opt_HF_DZ_RS-RFO
#rm -f slurm*
...
echo 'Convergence statistics' > report_triplets_opt_HF_DZ_RS-RFO
echo '' >> report_triplets_opt_HF_DZ_RS-RFO
echo 'Basis set: ' $BASIS >> report_triplets_opt_HF_DZ_RS-RFO
echo 'SCF input: ' $SCFTYPE >> report_triplets_opt_HF_DZ_RS-RFO
echo 'SCF input: ' $Opt >> report_triplets_opt_HF_DZ_RS-RFO
...
for mol in Coordinates/{00..264}*.xyz ; do
  ...
  echo '' >> ../report_triplets_opt_HF_DZ_RS-RFO
  echo $Project ":" >> ../report_triplets_opt_HF_DZ_RS-RFO
  echo $line1 >> ../report_triplets_opt_HF_DZ_RS-RFO
  echo $line2 >> ../report_triplets_opt_HF_DZ_RS-RFO
  echo $line3 >> ../report_triplets_opt_HF_DZ_RS-RFO
  echo $line4 >> ../report_triplets_opt_HF_DZ_RS-RFO
  echo $line5 >> ../report_triplets_opt_HF_DZ_RS-RFO
  rm -r *
  cd -
done
