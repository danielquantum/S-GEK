...
#SBATCH -J HF-DZ-TM_singlets-S-GEK
...
rm -f report_TM_singlets_HF_DZ_S-GEK
#rm -f slurm*
rm Logs_HF_DZ_S-GEK/*
...
echo 'Convergence statistics' > report_TM_singlets_HF_DZ_S-GEK
echo '' >> report_TM_singlets_HF_DZ_S-GEK
echo 'Basis set: ' $BASIS >> report_TM_singlets_HF_DZ_S-GEK
echo 'SCF input: ' $SCFTYPE >> report_TM_singlets_HF_DZ_S-GEK
echo 'SCF input: ' $Opt >> report_TM_singlets_HF_DZ_S-GEK
...
for mol in Coordinates/{000..274}.xyz ; do
  ...
  echo '' >> ../report_TM_singlets_HF_DZ_S-GEK
  echo $Project ":" >> ../report_TM_singlets_HF_DZ_S-GEK
  echo $line1 >> ../report_TM_singlets_HF_DZ_S-GEK
  echo $line2 >> ../report_TM_singlets_HF_DZ_S-GEK
  echo $line3 >> ../report_TM_singlets_HF_DZ_S-GEK
  echo $line4 >> ../report_TM_singlets_HF_DZ_S-GEK
  echo $line5 >> ../report_TM_singlets_HF_DZ_S-GEK
  rm -r *
  cd -
done
