...
#SBATCH -J B3LYP-DZ-singlets-S-GEK
...
rm -f report_singlets_B3LYP_DZ_S-GEK
#rm -f slurm*
...
echo 'Convergence statistics' > report_singlets_B3LYP_DZ_S-GEK
echo '' >> report_singlets_B3LYP_DZ_S-GEK
echo 'Basis set: ' $BASIS >> report_singlets_B3LYP_DZ_S-GEK
echo 'SCF input: ' $SCFTYPE >> report_singlets_B3LYP_DZ_S-GEK
echo 'SCF input: ' $Opt >> report_singlets_B3LYP_DZ_S-GEK
...
for mol in Coordinates/{00..264}*.xyz ; do
  ...
  echo '' >> ../report_singlets_B3LYP_DZ_S-GEK
  echo $Project ":" >> ../report_singlets_B3LYP_DZ_S-GEK
  echo $line1 >> ../report_singlets_B3LYP_DZ_S-GEK
  echo $line2 >> ../report_singlets_B3LYP_DZ_S-GEK
  echo $line3 >> ../report_singlets_B3LYP_DZ_S-GEK
  echo $line4 >> ../report_singlets_B3LYP_DZ_S-GEK
  echo $line5 >> ../report_singlets_B3LYP_DZ_S-GEK
  rm -r *
  cd -
done
