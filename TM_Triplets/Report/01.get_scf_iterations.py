...
#TM_Singlets
#files = ['report_TM_singlets_HF_DZ_qNRC2DIIS', 'report_TM_singlets_HF_DZ_RS-RFO', 'report_TM_singlets_HF_DZ_S-GEK', 'report_TM_singlets_B3LYP_DZ_qNRC2DIIS', 'report_TM_singlets_B3LYP_DZ_RS-RFO', 'report_TM_singlets_B3LYP_DZ_S-GEK']

#TM_Triplets
files = ['report_TM_triplets_HF_DZ_qNRC2DIIS', 'report_TM_triplets_HF_DZ_RS-RFO', 'report_TM_triplets_HF_DZ_S-GEK', 'report_TM_triplets_B3LYP_DZ_qNRC2DIIS', 'report_TM_triplets_B3LYP_DZ_RS-RFO', 'report_TM_triplets_B3LYP_DZ_S-GEK']
