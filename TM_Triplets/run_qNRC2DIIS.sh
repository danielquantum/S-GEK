...
#SBATCH -J HF-DZ-TM_triplets-qNRC2DIIS
...
rm -f report_TM_triplets_HF_DZ_qNRC2DIIS
#rm -f slurm*
...
echo 'Convergence statistics' > report_TM_triplets_HF_DZ_qNRC2DIIS
echo '' >> report_TM_triplets_HF_DZ_qNRC2DIIS
echo 'Basis set: ' $BASIS >> report_TM_triplets_HF_DZ_qNRC2DIIS
echo 'SCF input: ' $SCFTYPE >> report_TM_triplets_HF_DZ_qNRC2DIIS
echo 'SCF input: ' $Opt >> report_TM_triplets_HF_DZ_qNRC2DIIS
...
for mol in Coordinates/{000..274}.xyz ; do
  ...
  echo '' >> ../report_TM_triplets_HF_DZ_qNRC2DIIS
  echo $Project ":" >> ../report_TM_triplets_HF_DZ_qNRC2DIIS
  echo $line1 >> ../report_TM_triplets_HF_DZ_qNRC2DIIS
  echo $line2 >> ../report_TM_triplets_HF_DZ_qNRC2DIIS
  echo $line3 >> ../report_TM_triplets_HF_DZ_qNRC2DIIS
  echo $line4 >> ../report_TM_triplets_HF_DZ_qNRC2DIIS
  echo $line5 >> ../report_TM_triplets_HF_DZ_qNRC2DIIS
  rm -r *
  cd -
done
