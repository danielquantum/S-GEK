...
#SBATCH -J HF-DZ-TM_triplets-RS-RFO
...
#rm -f report_TM_triplets_HF_DZ_RS-RFO
#rm -f slurm*
...
echo 'Convergence statistics' > report_TM_triplets_HF_DZ_RS-RFO
echo '' >> report_TM_triplets_HF_DZ_RS-RFO
echo 'Basis set: ' $BASIS >> report_TM_triplets_HF_DZ_RS-RFO
echo 'SCF input: ' $SCFTYPE >> report_TM_triplets_HF_DZ_RS-RFO
echo 'SCF input: ' $Opt >> report_TM_triplets_HF_DZ_RS-RFO

for mol in Coordinates/{150..274}.xyz ; do
  cp $mol tmp2/.
  ...
  echo '' >> ../report_TM_triplets_HF_DZ_RS-RFO
  echo $Project ":" >> ../report_TM_triplets_HF_DZ_RS-RFO
  echo $line1 >> ../report_TM_triplets_HF_DZ_RS-RFO
  echo $line2 >> ../report_TM_triplets_HF_DZ_RS-RFO
  echo $line3 >> ../report_TM_triplets_HF_DZ_RS-RFO
  echo $line4 >> ../report_TM_triplets_HF_DZ_RS-RFO
  echo $line5 >> ../report_TM_triplets_HF_DZ_RS-RFO
  rm -r *
  cd -
done
